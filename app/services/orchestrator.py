...
SYSTEM_PROMPT_VERSICHERUNG = (
    ...
    "WICHTIGE REGELN:\n"
    "- KEIN Markdown: keine **Fettschrift**, keine *Kursivschrift*, keine ## Überschriften, keine - Aufzählungszeichen im Brieftext. "
    "Schreibe ausschließlich in juristischen Fließtext-Absätzen, getrennt durch Leerzeilen.\n"
...
SYSTEM_PROMPT_MANDANT = (
    ...
    "WICHTIGE REGELN:\n"
    "- KEIN Markdown: keine **Fettschrift**, keine *Kursivschrift*, keine ## Überschriften, keine - Aufzählungszeichen im Brieftext. "
    "Schreibe ausschließlich in freundlichem Fließtext, getrennt durch Leerzeilen.\n"
    "- Kein Briefkopf, keine Absender-/Empfängeradressen, kein Datum, kein Betreff, "
    "KEINE Anrede, KEINE Grußformel — diese Teile werden vom System automatisch eingefügt.\n"
    "- Schreibe NUR den reinen Fließtext des Briefes (ab dem ersten inhaltlichen Satz).\n"
